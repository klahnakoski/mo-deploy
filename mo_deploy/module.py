...
class Module(object):
    ...
    def update_setup_json_file(self, new_version):
        ...
        expected_packages = [
            ...
            if dir_name and not dir_name.startswith("tests/") and not dir_name.startswith(".") and not dir_name.startswith("vendor/") and dir_name != "tests"
        ]
    ...
    def get_version(self):
        ...
        all_versions = [v for line in stdout for v in [Version(line)] if v.prefix == 'v']
